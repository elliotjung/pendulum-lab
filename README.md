...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (1003 tests across 155 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
