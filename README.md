...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (1288 tests across 186 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
