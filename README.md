...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (1387 tests across 190 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
