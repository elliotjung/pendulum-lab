...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (1597 tests across 219 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
