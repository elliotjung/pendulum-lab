...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (1459 tests across 202 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
