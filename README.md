...
| `npm test` / `test:quick` / `test:slow` | Vitest unit suite (1079 tests across 173 files; synced from `reports/vitest-results.json`) plus quick/slow tiers for local and CI iteration |
