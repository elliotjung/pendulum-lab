...
import type { ClvSettings } from '../chaos/clv';
...
import { evaluateNChainVariationalTapeCpu, type NChainVariationalSummary } from './gpuNChainVariationalCpu';
import { WGSL_NCHAIN_TRAJECTORY_TAPE_KERNEL, WGSL_NCHAIN_VARIATIONAL_KERNEL } from './gpuNChainVariationalKernel';

export type { NChainVariationalSummary } from './gpuNChainVariationalCpu';
...
export function nChainVariationalCpuOracle(
  ...
  return evaluateNChainVariationalTapeCpu(tape, parameters.masses.length, settings);
}
