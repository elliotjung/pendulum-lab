...
export const integratorRegistry: Readonly<Record<IntegratorId, IntegratorMeta>> = Object.freeze({
  ...
  leapfrog: {
    ...
    dampingSupport: 'diagnostic-only',
    stabilityNotes: [
      'Only symplectic for separable canonical Hamiltonians; theta/omega coordinates are not sufficient for a blanket claim.'
    ],
    recommendedDt: [0.0005, 0.004]
  },
  symplectic: {
  ...
  yoshida6: {
    id: 'yoshida6',
    name: 'Yoshida 6 Composition',
    order: 6,
    symplectic: 'separable-approximation',
    dampingSupport: 'diagnostic-only',
    stabilityNotes: [
      'Symmetric triple-jump composition of Yoshida-4; the symplectic claim still requires a valid separable canonical split.',
      'Negative substeps enlarge the error constant on velocity-coupled or dissipative systems.'
    ],
    recommendedDt: [0.0005, 0.004]
  },
  yoshida8: {
    id: 'yoshida8',
    name: 'Yoshida 8 Composition',
    order: 8,
    symplectic: 'separable-approximation',
    dampingSupport: 'diagnostic-only',
    stabilityNotes: [
      'Symmetric triple-jump composition of Yoshida-6; the symplectic claim still requires a valid separable canonical split.',
      'Twenty-seven leapfrog substeps make this a high-accuracy research method, not the default interactive method.'
    ],
    recommendedDt: [0.0005, 0.004]
  },
  hmidpoint: {
