...
.persona-paths{margin:0 0 12px;border:1px solid var(--workbench-border,rgba(205,214,245,.08));border-radius:2px;background:var(--workbench-panel,#10141f)}
...
.persona-entry{min-width:0;padding:9px;text-align:left;border:1px solid var(--workbench-border,rgba(205,214,245,.08));border-radius:2px;background:transparent;color:var(--workbench-text,#f1f3f8);font-size:10.5px}
.guided-experiment{margin:0 0 13px;padding:13px;border:1px solid var(--workbench-border-strong,rgba(205,214,245,.14));border-radius:2px;background:var(--workbench-panel,#10141f);box-shadow:none}
...
.workflow-progress{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:0;margin:11px 0;border:1px solid var(--workbench-border,rgba(205,214,245,.08))}.workflow-step{min-width:0;padding:7px 5px;border:0;border-right:1px solid var(--workbench-border,rgba(205,214,245,.08));border-radius:0;background:transparent;color:var(--workbench-text-muted,#737e92);font:600 9px/1.25 var(--font-sans,system-ui)}.workflow-step:last-child{border-right:0}.workflow-step[aria-current="step"]{color:var(--workbench-text,#f1f3f8);box-shadow:inset 0 -2px 0 var(--workbench-live,#72d6e5)}
.workflow-current{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center;padding:10px;border:1px solid var(--workbench-border,rgba(205,214,245,.08));border-radius:2px;background:var(--workbench-control,#181d2b)}.workflow-current strong{display:block;color:var(--workbench-text,#f1f3f8);font-size:12px}.workflow-current span{display:block;margin-top:3px;color:var(--workbench-text-secondary,#a8b0c2);font-size:10px;line-height:1.45}.workflow-actions{display:flex;gap:6px;align-items:center}.workflow-actions button:first-child{border-color:var(--workbench-live,#72d6e5)}
.workflow-measurement{display:block;margin-top:6px;color:var(--workbench-text-muted,#737e92);font-size:9.5px;line-height:1.45}
.trajectory-role-panel{margin:11px 0 0;padding:11px 0 0;border:0;border-top:1px solid var(--workbench-border-strong,rgba(205,214,245,.14));border-radius:0;background:transparent}
...
.ensemble-statistics{margin-top:10px;padding-top:10px;border-top:1px solid var(--workbench-border,rgba(205,214,245,.08))}.ensemble-spaghetti-toggle{display:flex;align-items:center;gap:6px;color:var(--workbench-text-secondary,#a8b0c2);font-size:9.5px}.ensemble-statistics-summary{margin:7px 0;color:var(--workbench-text-secondary,#a8b0c2);font:9.5px/1.5 var(--font-mono,monospace)}#ensembleStatisticsPlot{display:block;width:100%;height:24px;border:1px solid var(--workbench-border-strong,rgba(205,214,245,.14));background:#0b0e15}[data-ensemble-band]{fill:#5f92b8;opacity:.42}[data-ensemble-median]{stroke:#9bc4df;stroke-width:1}
