...
export const NAV_TAB_LABEL_KO: Record<string, string> = {
  lab: '실험실', compare: '비교', lyap: '리아푸노프', sweep: '카오스 지도', bifurc: '분기',
  phase3d: '3D 위상', density: '밀도', zeroone: '0–1 검정', clv: 'CLV', basin: '흡인역',
  rqa: 'RQA', ftle: 'FTLE', validate: '검증', research: '연구+', architecture: '구조',
  lab3d: '3D 실험실', canonical: '정준 검증', aplus: '감사', docs: '문서', expansion: '확장',
  matrix: '연구 행렬', golden: '기준 비교'
};

export const NAV_ACTION_LABEL_KO: Record<string, string> = {
  floquet: '플로케', manifest: '매니페스트', integrity: '무결성', palette: '명령 찾기', report: '리포트'
};
