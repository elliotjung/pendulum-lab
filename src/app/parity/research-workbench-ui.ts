...
import { append, button, card, currentSnapshot, detailsCard, html, kvGrid, state, toast } from './shared';
import {
...
import { installResearchWorkbenchEventBridge } from './research-workbench-events';
import {
...
export function installResearchTab(): void {
  installResearchWorkbenchEventBridge(renderResearchWorkbench);
