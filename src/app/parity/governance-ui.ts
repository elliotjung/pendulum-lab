...
import { LEGACY_VALIDATION_IDS, append, button, card, clear, currentSnapshot, detailsCard, html, kvGrid, modernLab, record, setActiveTab, setControl, state, toast } from './shared';
import { exportFaultReport, exportValidationJson, renderRuntimePanels, runAPlusAudit, runCanonicalQa, runFloquetProbe, runLegacyValidationSurface } from './runtime-diagnostics';
...
import { $ } from './shared';
import { exportFeatureReport, exportManifest, showFeaturePanel } from './governance-feature';
import { paragraph } from './governance-panels';

export { bindExtraTabClicks, installExtraTabs } from './governance-tabs';
export { bulletList, installAPlusTab, installArchitectureTab, installCanonicalTab, installDocsTab, methodTable, paragraph } from './governance-panels';
export { capabilityText, exportAPlusReport, exportFeatureReport, exportManifest, featureDomOk, featureInventory, featureReport, figCard, installFeatureBadge, renderFeatureBadge, showFeaturePanel } from './governance-feature';
